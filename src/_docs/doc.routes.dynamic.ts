...
export const ROUTES: Routes = [
  ...
  { path: 'experimental/ip-validator', component: BaseDocPageComponent, data: {
    path: '_docs/experimental/ip-validator',
    componentName: 'SamIpValidatorComponent',
			sections: ['component-example.html','component-example.ts','documentation.md']}, children: [
    { path: '', component: SamIpValidatorComponentExampleComponent }
  ]},
